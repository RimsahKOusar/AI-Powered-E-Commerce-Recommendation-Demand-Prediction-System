...
// Simple stock-level threshold — a stand-in for the real M2 coverage/risk
...
export default async function InventoryPage() {
  const { data: products } = await listProducts({ sort: "stock", page_size: 100 });
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <Card className="flex items-center gap-3 p-4">
          ...
          <div>
            ...
            <div className="text-xs text-muted">Low stock (≤15)</div>
          </div>
        </Card>
        <Card className="flex items-center gap-3 p-4">
